...
const createUser = asyncHandler(async (req, res) => {
  ...
  // check the admin register or not
   checkUserType == 0 ? roleType = 'admin' : roleType = 'user';
    ...
    const query = { firstName:first_name, lastName:last_name, userName:uname, email: email.toLowerCase(), mobile: contact, status:1, password: encryptedPassword, roleType: roleType };
